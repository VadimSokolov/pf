...
public class JUnittest {
	...
	{
		//Chicago downtown
		Utils.GeoPoint pt = new  Utils.GeoPoint(Utils.to_decimal_degrees(41, 52, 55), -Utils.to_decimal_degrees(87,37,40));
		//move lat by 1 second north
		Utils.GeoPoint pt1 = new Utils.GeoPoint(Utils.to_decimal_degrees(41, 52, 56), -Utils.to_decimal_degrees(87,37,40));
	...
	public void test_move_lat_lon2()
	{
		...
		Utils.GeoPoint pt1 = new Utils.GeoPoint(Utils.to_decimal_degrees(41, 52, 65), -Utils.to_decimal_degrees(87,37,40));
	...
	public void test_move_lat_lon3()
	{
		...
		Utils.GeoPoint pt1 = new Utils.GeoPoint(Utils.to_decimal_degrees(41, 52, 55), -Utils.to_decimal_degrees(87,37,41));
		//Length of a Degree of Latitude and Longitude calculator:
		//http://msi.nga.mil/MSISiteContent/StaticFiles/Calculators/degree.html
	...
	public void test_move_lat_lon30()
	{
		...
		Utils.GeoPoint pt1 = new Utils.GeoPoint(Utils.to_decimal_degrees(41, 52, 55), -Utils.to_decimal_degrees(87,37,30));
		//Length of a Degree of Latitude and Longitude calculator:
		//http://msi.nga.mil/MSISiteContent/StaticFiles/Calculators/degree.html
	...
	public void test_move_lat_lon4()
	{
		...
		Utils.GeoPoint pt1 = new Utils.GeoPoint(Utils.to_decimal_degrees(41, 52, 56), -Utils.to_decimal_degrees(87,37,41));
		//Length of a Degree of Latitude and Longitude calculator:
		//http://msi.nga.mil/MSISiteContent/StaticFiles/Calculators/degree.html
